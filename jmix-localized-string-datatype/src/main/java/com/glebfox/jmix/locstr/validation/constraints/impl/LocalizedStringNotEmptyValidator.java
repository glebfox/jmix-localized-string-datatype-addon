...
/**
 * Bean Validation validator for {@link LocalizedStringNotEmpty}.
 */
public class LocalizedStringNotEmptyValidator implements ConstraintValidator<LocalizedStringNotEmpty, LocalizedString> {
